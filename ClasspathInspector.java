...
//		javaClassPath = "/Users/nikhil/mavq/command-centre/build/libs/command_center-0.0.1-SNAPSHOT-plain.jar";
//        System.out.println(javaClassPath);
	...
	public static void main(String[] args) {
		...
		System.out.printf("There are %s classes available in the classpath%n", allClasses.size());
